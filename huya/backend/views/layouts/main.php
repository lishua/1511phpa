                        ...
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                ...
                                <span class="user-info">
                                    ...
                                    echo isset($user['username'])?'欢迎光临,<br>'.$user['username']:'<a href="'.Url::toRoute(['login/login']).'">登录</a>';
                                    ?>
                                    </small>
                                </span>
                            ...
                            <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                                ...
                                <li>
                                    <a href="<?=Url::toRoute(['site/login_out']) ?> ">
                                        <i class="icon-off"></i>
                                        退出
                                    </a>
                                </li>
                ...
                <div class="sidebar" id="sidebar">
                    ...
                    <ul class="nav nav-list">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?= Url::toRoute(['site/zb_add']); ?>">
                                ...
                                <li>
                                    <a href="<?= Url::toRoute(['site/zb_list']); ?>">
                                        <i class="icon-double-angle-right"></i>
                                        主播列表
                                    </a>
                                </li>
...
<!--                                 <li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?= Url::toRoute(['site/zb_typeadd']); ?>">
                                        <i class="icon-double-angle-right"></i>
                                        添加分类
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="<?= Url::toRoute(['site/zb_type']); ?>">
                                        <i class="icon-double-angle-right"></i>
                                        分类列表
                                    </a>
                                </li>
